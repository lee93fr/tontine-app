...
<head>
    ...
    <title>{{ __('app.auth.confirm_title') }} — TontineApp</title>
...
<body class="bg-gradient-to-br from-indigo-50 to-purple-50 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-1 text-sm">{{ __('app.auth.confirm_title') }}</p>
        </div>
        ...
        <p class="text-sm text-gray-600 mb-6">{{ __('app.auth.confirm_desc') }}</p>
